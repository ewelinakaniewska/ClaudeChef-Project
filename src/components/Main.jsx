...
export default function Main() {
  ...
  const ingredientsListItems = ingredients.map((ingredient) => {
    return (
      <li
        key={ingredient}
        className="text-[#475467] text-[1.125rem] font-[400] font-[Inter] leading-[250%]"
      >
        {ingredient}
      </li>
    );
  ...
  return (
    <main className="flex flex-col items-center">
      ...
      {recipeShown && (
        <section className="w-[601px] text-[#475467]">
          <h2 className="text-[1.875rem] text-[#141413] font-[Inter] font-semibold">
            Suggested Recipe:
          </h2>
          <article className="suggested-recipe-container" aria-live="polite">
            ...
            <ol className="list-decimal list-inside indent-3 p-2">
              <li>
